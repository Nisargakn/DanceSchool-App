          ...
          {users.map((branchData, i) => {
            return (
              <tr key={i}>
                ...
                <td>
                  <button><Link to={`/adminDashboard/viewAcademy/updateAcademy/${branchData.id}`}>UPDATE</Link></button>
                </td>
                <td>
                  <button>
                    <Link to={`/adminDashboard/viewAcademy/addBranch/${branchData.id}`}>ADD BRANCH</Link>
                  </button>
                </td>
                <td>
                  <button onClick={()=>{handleDelete(branchData.id)}}><Link>DELETE</Link></button>
                </td>
              </tr>
            )
          })}
